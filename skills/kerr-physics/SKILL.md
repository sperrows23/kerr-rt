...
> absorption + the CKS-15 shadow bake←ρ_cold).** Grey scalar κ (κ_R=κ_G=κ_B); the
> per-channel `dτ⃗` transmittance below is the chromatic-ready extension, DEFERRED (Task 7).
